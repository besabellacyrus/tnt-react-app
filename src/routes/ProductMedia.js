...
const ProductMedia = (props) => {
  ...
  const onDrop = useCallback(acceptedFiles => {
    let theimage;
    console.log({ acceptedFiles: acceptedFiles, showModal })
  ...
  const handleMultipleUpload = () => {
    ...
    // multiple.dispatchEvent(clickEvent);
    setShowModal(true);
                  ...
                  <div className="content-item">
                    <div className="aligner">
                      ...
                      {/* <div className="image-footer">
                        <select onChange={handleOnChangeItem}>
                          <option>Set as Thumbnail</option>
                          <option>Set as Banner</option>
                          <option>Set Display</option>
                          <option>Crop Thumbnail</option>
                          <option>Free Crop</option>
                        </select>
                      </div> */}
                    </div>
                  </div>
                  <div className="content-item">
                    <img src="/img/thumbnail/MEZ77480_thumbnail.jpg" />
                    <div className="image-footer">
                      <select onChange={handleOnChangeItem}>
                        <option>Set as Thumbnail</option>
                        <option>Set as Banner</option>
            ...
            <div className="row">
              <div className="product-images">
                ...
                <div className="col-sm-9">
                  {/* <SlideShow /> */}
                  <div>
                    <div id="multiple-uploads" {...getRootProps()}>
                      <input {...getInputProps()} />
                      {
                        isDragActive ?
                  ...
                  <button onClick={handleMultipleUpload} className="btn app-btn btn-primary btn-icon left-icon mb-30 free-width"> <i className="fa fa-paperclip"></i> <span>Media Upload</span></button>
                </div>
              </div>
            </div>
            <hr></hr>
